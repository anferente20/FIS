...
\begin{document}
	...
	{\begin{tikzpicture}[remember picture,overlay]
		\node[anchor=north west,inner sep=0pt] at (0,0) {\includegraphics[width=\paperwidth,height=\paperheight]{1}}; % Background image
...
\chapterimage{4.pdf} % Table of contents heading image
\pagestyle{empty} % No headers
...
\include{proyecto/proceso/proceso}
\part{DISEÑO}
